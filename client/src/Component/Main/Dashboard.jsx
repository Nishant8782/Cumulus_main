                  ...
                  <div className="mt-4">
                    ...
                    {selectedFolderId ? (
                      ...
                      <div className="flex flex-col">
                        ...
                        <h1 className="block mb-2">Select a Folder to Upload File:</h1>
                        ...
                        </div>
                      {
                        createFolderPopuup && (
                          <>
                            <div
                          className="border p-2 rounded w-full max-h-28 overflow-y-scroll bg-white mt-2"
                          onChange={(e) => {
                        ...
                        >
                          <button
                    onClick={() => addFolder()}
                    className="p-1 text-md text-gray-500 cursor-pointer font-semibold"
                  >
                    Create New Folder
                  </button>
