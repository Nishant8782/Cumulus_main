...
import { ArrowRight, Camera, Menu, LayoutGrid, X, FileClock, ChevronDown, Users, Edit, Eye, Trash2, EllipsisVertical, Download, Search } from 'lucide-react';
...
const Voicememo = ({ searchQuery }) => {
  ...
  const handleSaveEdits = async (id) => {
    try {
      ...
      if (response.ok) {
        ...
        alert(result.error || "Failed to update voice memo name");
      }
    } catch (error) {
      console.error("Error updating voice memo name:", error);
      alert("Error updating voice memo name");
    }
  };
  ...
  return (
    <div className="mt-1 p-2 sm:p-4 max-h-screen bg-white overflow-hidden">
      ...
      {showPopup && (
        <div className="fixed top-1/2 sm:top-1/3 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-white p-3 sm:p-6 shadow-lg rounded-lg w-2/3 sm:w-[25%]">
          <div className="flex justify-between">
                      ...
                      >
                        <div className="flex gap-4 items-center">
                          ...
                          >
                            ...
                            <span className="absolute bottom-[-46px]  left-2/3 transform -translate-x-1/2 hidden group-hover:block bg-white w-24 text-black text-xs py-1 px-2 rounded shadow">
                              Share with Designee
                            </span>
                          </button>
                          <button
                          ...
                          versionHistory && (
                            <>
                              <div className="h-screen w-screen fixed pr-6 inset-0 flex justify-between items-center z-50">
                                ...
                                <div></div>
                                <div className="mt-20 bg-white opacity-100 relative"> {/* Main content with full opacity */}
      ...
      <div className="md:hidden grid grid-cols-1 gap-y-3 gap-x-2 mt-4 overflow-y-scroll max-h-96 scroll-smooth">
