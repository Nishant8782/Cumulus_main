...
const SharedFiles = () => {
  ...
  console.log("groupeeddddddddddddddddddddddddddddddddddddddddddddddddddddd", groupedFiles)
            ...
            <div className="flex justify-between items-center md:px-0 border-gray-300">
              <div className="text-sm">
                <div onClick={handlesharedItem} className={`${sharedItem ? 'flex items-center md:gap-x-2 border-b-4 border-blue-600 text-blue-600' : 'flex items-center md:gap-x-2'}`}>
                  ...
                  <span className="text-black rounded-lg text-sm mt-1 mb-2 px-2.5 bg-[#EEEEEF]">{afterfile.length - 2}</span>
                </div>
                <div className=""></div>
              </div>
            </div>
                                    ...
                                    <td className="w-[30%]">
                                      <div className="flex items-center cursor-pointer relative">
                                        <div className="flex">
                                          ...
                                          />
                                          <div>
                                            <p className="font-semibold mb-1"> {(totalItems[0]?.file_name || totalItems[0]?.voice_name)?.length > 30
                                              ? `${(totalItems[0]?.file_name || totalItems[0]?.voice_name).substring(0, 30)}...`
                                          ...
                                          {files.map((file, index) => (
                                            ...
                                            >
                                              <div className="flex items-center" >
                                                ...
                                                <p className="text-sm font-semibold ml-4 mt-1"> {file.file_name.length > 30 ? `${file.file_name.substring(0, 30)}...` : file.file_name}</p>
                                                {/* <img
                                                  className="w-5 h-5"
                                                  src={editicon}
                                                  alt="Edit Icon"
